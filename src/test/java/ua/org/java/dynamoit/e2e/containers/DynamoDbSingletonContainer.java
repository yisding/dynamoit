...
package ua.org.java.dynamoit.e2e.containers;
...
public class DynamoDbSingletonContainer {
    ...
    static {
        @SuppressWarnings("resource") // Container is intentionally kept open as singleton
        GenericContainer<?> container = new GenericContainer<>("amazon/dynamodb-local:latest")
